    ...
    public partial class Upload : Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string path = FileHelper.Combine(RouteData.GetRelativePath(), file.FileName), 
                    ...
                    using (var stream = new FileStream(FileHelper.GetFilePath(path), FileMode.Create, FileAccess.Write, 
